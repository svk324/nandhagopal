      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8">
        <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-center text-black dark:text-white font-sans tracking-tight">
          ...
          <div className="relative mx-auto inline-block w-full max-w-4xl">
            <div className="absolute inset-0 bg-clip-text text-transparent bg-linear-to-r from-purple-500 via-violet-500 to-pink-500 py-4">
              <span className="block text-shadow-lg">Unveiling Soon…</span>
            </div>
            <div className="relative bg-clip-text text-transparent bg-linear-to-r from-purple-500 via-violet-500 to-pink-500 py-4">
              <span className="block text-shadow-lg">Unveiling Soon…</span>
            </div>
          </div>
        </h2>
